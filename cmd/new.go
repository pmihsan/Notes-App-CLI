...
var newCmd = &cobra.Command{
	...
	Long: `Helps to create a new table for making notes`,
...
func createNotes() {
	wordPromptContent := promptContent{
		...
		"What word would you like to take a note of? ",
	}

	word := promptGetInput(wordPromptContent)

	definitionPromptContent := promptContent{
		"Please provide the word's definition",
	...
	categoryPromptContent := promptContent{
		"Please provide a category for the word",
